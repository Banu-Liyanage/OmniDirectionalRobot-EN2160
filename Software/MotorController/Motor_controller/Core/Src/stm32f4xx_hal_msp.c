...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, M1_CS_Pin|M2_CS_Pin|M3_CS_Pin|M4_CS_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(M1_EncoderCH1_GPIO_Port, M1_EncoderCH1_Pin);

    HAL_GPIO_DeInit(M1_EncoderCH2_GPIO_Port, M1_EncoderCH2_Pin);
  ...
  else if(htim_encoder->Instance==TIM3)
  {
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, M2_EncoderCH1_Pin|M2_EncoderCH2_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, M3_EncoderCH1_Pin|M3_EncoderCH2_Pin);
  ...
  else if(htim_encoder->Instance==TIM5)
  {
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, M4_EncoderCH1_Pin|M4_EncoderCH2_Pin);
